...
def build_graph():
    ...
    # Changed from "excel_analysis"
    graph.add_node("analyzer", excel_analysis_node)
    # Changed from "excel_formula"
    graph.add_node("formula_gen", excel_formula_node)
    ...
    graph.set_entry_point("chatbot")  # Updated
